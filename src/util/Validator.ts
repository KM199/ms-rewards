...
export const ConfigSchema = z.object({
    ...
    workers: z.object({
        ...
        doLimitedSearchBonus: z.boolean()
    }),
    ...
    searchSettings: z.object({
        ...
        /** Dwell on results page after submitting a query (before reading counters). */
        searchDelay: DelaySchema,
        /** Random wait before starting the next search (rate-limit experiments). */
        betweenSearchDelay: DelaySchema.optional(),
